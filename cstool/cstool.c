...
static struct {
   ...
   { "avr", "AVR microcontroller, little endian", CS_ARCH_AVR, CS_MODE_LITTLE_ENDIAN },
...
static void print_details(csh handle, cs_arch arch, cs_mode md, cs_insn *ins)
{
   ...
   switch(arch) {
   	...
   	case CS_ARCH_ARC:
   		...
   		break;
   	case CS_ARCH_AVR:
   		print_insn_detail_avr(handle, ins);
   		break;
   	default: break;
   }
