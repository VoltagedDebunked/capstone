...
static const avr_decode16_entry_t decode16_table[] = {
    ...
    // Branch on Status Register
    { 0xFC00, 0xF000, AVR_INS_BRBS, DecodeBranch },  // BRBS s, k
    { 0xFC00, 0xF400, AVR_INS_BRBC, DecodeBranch },  // BRBC s, k
    { 0xFC07, 0xF001, AVR_INS_BREQ, DecodeBranch },  // BREQ k
    { 0xFC07, 0xF401, AVR_INS_BRNE, DecodeBranch },  // BRNE k
    { 0xFC07, 0xF000, AVR_INS_BRCS, DecodeBranch },  // BRCS k
    { 0xFC07, 0xF400, AVR_INS_BRCC, DecodeBranch },  // BRCC k
    { 0xFC07, 0xF002, AVR_INS_BRMI, DecodeBranch },  // BRMI k
    { 0xFC07, 0xF402, AVR_INS_BRPL, DecodeBranch },  // BRPL k
    ...
    { 0xD208, 0x8000, AVR_INS_LDD, DecodeIndirectDisp }, // LDD Rd, Z+q
    ...
    { 0xF800, 0xB800, AVR_INS_OUT, DecodeIOImm },    // OUT A, Rr
    ...
    { 0xFE0F, 0x940E, AVR_INS_LSL, DecodeRd },       // LSL Rd (same as ADD Rd, Rd)
    ...
    { 0xFF8F, 0x9408, AVR_INS_BSET, DecodeRdK6 },    // BSET s
    { 0xFF8F, 0x9488, AVR_INS_BCLR, DecodeRdK6 },    // BCLR s
    ...
    { 0xFF00, 0x0200, AVR_INS_MULS, DecodeRdRr },    // MULS Rd, Rr
    { 0xFF88, 0x0300, AVR_INS_MULSU, DecodeRdRr },   // MULSU Rd, Rr
    { 0xFF88, 0x0308, AVR_INS_FMUL, DecodeRdRr },    // FMUL Rd, Rr
    { 0xFF88, 0x0380, AVR_INS_FMULS, DecodeRdRr },   // FMULS Rd, Rr
    { 0xFF88, 0x0388, AVR_INS_FMULSU, DecodeRdRr },  // FMULSU Rd, Rr
};
...
static DecodeStatus DecodeBranch(MCInst *MI, uint16_t insn, uint64_t addr, const void *decoder)
{
    ...
    MCOperand_CreateImm0(MI, offset);
...
static DecodeStatus DecodeIndirect(MCInst *MI, uint16_t insn, uint64_t addr, const void *decoder)
{
    ...
    // Determine pointer register based on instruction bits
    if ((insn & 0x000C) == 0x000C)      // X register
        ptr = AVR_REG_X;
    else if ((insn & 0x0008) == 0x0008) // Y register
        ptr = AVR_REG_Y;
    else                                // Z register
        ptr = AVR_REG_Z;
